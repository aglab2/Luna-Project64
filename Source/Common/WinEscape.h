...
namespace WinEscape
{
    ...
    std::wstring OpenFileDialog(void* hwndOwner, std::vector<Filter> filters = {}, const wchar_t* initialDir = nullptr);
    ...
    namespace Utf8
    {
        std::string OpenFileDialog(void* hwndOwner, std::vector<Filter> filters = {}, const char* initialDir = nullptr);
