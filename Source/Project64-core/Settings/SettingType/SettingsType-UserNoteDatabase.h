...
class CSettingTypeUserNoteDatabase :
    public CSettingType
{
public:
    CSettingTypeUserNoteDatabase(const char * Name, const char * DefaultValue, bool DeleteOnDefault = false);
    CSettingTypeUserNoteDatabase(const char * Name, bool DefaultValue, bool DeleteOnDefault = false);
    CSettingTypeUserNoteDatabase(const char * Name, uint32_t DefaultValue, bool DeleteOnDefault = false);
    CSettingTypeUserNoteDatabase(const char * Name, SettingID DefaultSetting, bool DeleteOnDefault = false);

    virtual ~CSettingTypeUserNoteDatabase();
...
protected:
    ...
    static CIniFile * m_UserNoteIniFile;

private:
    CSettingTypeUserNoteDatabase();
    CSettingTypeUserNoteDatabase(const CSettingTypeUserNoteDatabase&);
    CSettingTypeUserNoteDatabase& operator=(const CSettingTypeUserNoteDatabase&);
