...
bool CMainMenu::ProcessMessage(HWND hWnd, DWORD /*FromAccelerator*/, DWORD MenuID, DWORD lparam)
{
    ...
    case ID_LUNA_CREATE_RENDER_HWND:
    {
        ...
        *phwnd = CreateWindowExW(0, L"LunaProject64Render", nullptr, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN, 0, 0, 1, 1, m_Gui->MainWindow(), NULL, GetModuleHandle(NULL), NULL);
    }
    break;
