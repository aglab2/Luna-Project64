	...
	public CSettingsPage
{
	...
	BEGIN_MSG_MAP_EX(CGeneralOptionsPage)
		...
		COMMAND_ID_HANDLER_EX(IDC_MINIMIZEDSLEEP, CheckBoxChanged)
		...
		COMMAND_ID_HANDLER_EX(IDC_GLOBAL_CHEATS, CheckBoxChanged)
		COMMAND_ID_HANDLER_EX(IDC_RETROACHIEVEMENTS, CheckBoxChanged)
		COMMAND_ID_HANDLER_EX(IDC_CONFIG_APPDATA, CheckBoxChanged)
		...
		COMMAND_HANDLER_EX(IDC_INPUTDELAY,EN_UPDATE,EditBoxChanged)
	END_MSG_MAP()
